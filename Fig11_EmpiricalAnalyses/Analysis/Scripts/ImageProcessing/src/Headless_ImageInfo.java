 ...
 */
public class Headless_ImageInfo {
    ...
    private int width;
    private int height;
    private ImageParser ii;

    public Headless_ImageInfo(String name) {
        setName(name);
    }
    ...
    public int getDPIWidth() {
        if(ii!=null) return ii.getPhysicalWidthDpi();
        return -1;
    }
    
    public int getDPIHeight() {
        if(ii!=null) return ii.getPhysicalHeightDpi();
        return -1;
    }
    
    public float getWidthInches() {
        if(ii!=null) return ii.getPhysicalWidthInch();
        return -1F;
    }
    
    public float getHeightInches() {
        if(ii!=null) return ii.getPhysicalHeightInch();
        return -1F;
    }
    ...
    public boolean equals(Object o) {
        return o instanceof Headless_ImageInfo && toString().equals(o.toString());
    }
 ...
 * Headless_ImageInfo (above) to determine the width and height of an image.
 * It is made package-private because it is not intended to be used
 * directly.
 */

/*
 * Headless_ImageInfo.java
 *
 * Version 1.5
 *
 ...
 * <pre>
 Headless_ImageInfo ii = new Headless_ImageInfo();
 ...
 * <pre>
   java Headless_ImageInfo *.jpg *.png *.gif http://somesite.tld/image.jpg
 </pre>
 * or call it without parameters and pipe data to it:
 * <pre>
   java Headless_ImageInfo &lt; image.jpg  
 * </pre>
 * <p>
 * Known limitations:
 * <ul>
 ...
 *  interlaced PNG and GIF. A new method {@link #isProgressive()} returns whether Headless_ImageInfo
